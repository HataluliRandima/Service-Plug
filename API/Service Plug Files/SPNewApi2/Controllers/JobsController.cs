...
namespace SPNewApi2.Controllers
{
    ...
    public class JobsController : ControllerBase
    {
        ...
        public async Task<IActionResult> getalljobssall()
        {
            ...
            try
            {
              var listuser = _context.Jobs.Select(s => new
                {
        ...
        public async Task<IActionResult> jobconfirm([FromBody] Jobconfirm combook, int id)
        {
            ...
            dbbook.JobDateend = DateTime.Now;
        ...
        //Get all the jobs for specefic merchant  the numbers
        [HttpGet]
        [Route("getjobnbyno")]
        public async Task<IActionResult> getjobssMerchantNo()
        {

            List<Job> listuser = _context.Jobs.Where(t => t.JobStatus == "Active").ToList();
            if (listuser != null)
            {
