...
namespace SPNewApi2.Controllers
{
    ...
    public class ReviewsController : ControllerBase
    {
        ...
        public async Task<IActionResult> getallreviews()
        {
            ...
            try
            {
               var listuser = _context.Reviews.Select(s => new
                {
        ...
        [HttpGet]
        [Route("getreview2/{id}")]
        public async Task<IActionResult> getmerchantreview2(int id)
        {
            try
            {
        ...
        [HttpGet]
        [Route("getallreviewNO")]
        public async Task<IActionResult> getallreviewsnumber()
        {
