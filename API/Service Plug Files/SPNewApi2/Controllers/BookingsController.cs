...
namespace SPNewApi2.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("bookby/{id}")]
        public async Task<IActionResult> getbookingtid(int id)
        {
            ...
            if (user11 == null)
            {
                return BadRequest("Cant find the specific booking");
        ...
        public async Task<IActionResult> getbookings()
        {
            ...
            List<Booking> listuser = _context.Bookings.Where(t => t.UserId == userID).OrderByDescending(t => t.BookId).ToList();
            if (listuser != null)
            {
                return Ok(listuser);
            }
        ...
        public async Task<IActionResult> getallbookingsall()
        {
            ...
            try
            {
                var listuser = _context.Bookings.Select(s => new
                {
                    username = s.User.UserName,
                    usersurname = s.User.UserSurname,
                    merchname = s.Merch.MerchName,
                    merchsurnname = s.Merch.MerchSurname,
                    merchtype = s.Merch.MerchType,
                    s.BookDate,
                    s.BookTime,
                    s.BookStatus,
                    s.BookId,
        ...
        public async Task<IActionResult> getbookRequest()
        {
            ...
            try
            {
                ...
                var quolist = _context.Bookings.Select(t => new
                {
                    ...
                    t.BookTime,
                    t.BookMessage,
                }).Where(t => t.MerchId == userID && t.BookStatus == "InActive").OrderByDescending(t => t.BookId).ToList();
        ...
        public async Task<IActionResult> getActiveRequests()
        {
            ...
            try
            {
                ...
                var quolist = _context.Bookings.Select(t => new
                {
                    ...
                    t.BookTime,
                    t.BookMessage
                }).Where(t => t.MerchId == userID && t.BookStatus == "Active").OrderByDescending(t => t.BookId).ToList();
        ...
        [HttpGet]
        [Route("totRequestPerMonth/{month}")]
        public async Task<int> getTotalRequestsPerMonth(int month)
        {
        ...
        //Get all Merchants
        [HttpGet]
        [Route("getallbookingsNO")]
        public async Task<IActionResult> getallbookingsnumber()
        {
        ...
        public async Task<IActionResult> getsing(int id)
        {
            ...
            var booklist = _context.Bookings.Select(t => new
            {
                ...
                t.BookDate,
                t.BookTime
            }).Where(t => t.MerchId == id && t.BookStatus == "Active").ToList();
